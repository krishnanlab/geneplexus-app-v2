    ...
    <>
      ...
      <Section>
        ...
        <TextBox
          className="narrow"
          label="Name"
          tooltip="(Optional) A name to remember your analysis by. Used as a filename when saving results, and shown on Load Analysis and Analysis pages so you can quickly identify different analyses."
